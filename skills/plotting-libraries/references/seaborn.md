...
Python visualization library for creating publication-quality statistical graphics. Use seaborn for dataset-oriented plotting, multivariate analysis, automatic statistical estimation, and complex multi-panel figures with minimal code.
