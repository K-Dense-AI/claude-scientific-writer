# Scientific Schematics - Nano Banana 2 or Atlas Cloud

**Generate any scientific diagram by describing it in natural language.**

Nano Banana 2 creates publication-quality diagrams automatically by default. Atlas Cloud can be selected as an optional image-generation backend when you want to use its async media API.
