...
#### Step 5.3: Commit with descriptive message

```bash
git commit -m "$(cat <<'EOF'
refactor: remove clinical and business-focused skills

Remove 5 skills that are outside the core scientific research focus:
- research-grants
...
Updated cross-skill references in:
- venue-templates
...
This streamlines the fork for scientific research document generation.
...
- **Skills removed:** `research-grants`, `clinical-decision-support`, `clinical-reports`, `market-research-reports`, `treatment-plans`
  - These clinical and business-focused skills were outside the core scientific research scope
  - Cross-skill references updated in `venue-templates` and `hypothesis-generation`
